...
public class AdminUserBanActivity extends AppCompatActivity {
    RecyclerView recyclerViewUsers;
    UserBanAdapter userBanAdapter;
            ...
            public void onResponse(Call<List<UserInfo>> call, Response<List<UserInfo>> response) {
                ...
                if(response.isSuccessful()) {
                    if(userList == null) {
                        ...
                        userBanAdapter = new UserBanAdapter(AdminUserBanActivity.this, userList, userManagementService);
                        recyclerViewUsers.setAdapter(userBanAdapter);
                    }
                } else {
