...
public class UserBanAdapter extends RecyclerView.Adapter<UserBanAdapter.UserBanViewHolder> {
    Context context;
    List<UserInfo> userList;
    UserManagementService userManagementService;

    public UserBanAdapter(Context context, List<UserInfo> userList, UserManagementService userManagementService) {
        this.context = context;
        this.userList = userList;
        this.userManagementService = userManagementService;
    }

    public static class UserBanViewHolder extends RecyclerView.ViewHolder {
    ...
    public UserBanViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.admin_user_ban_item, parent, false);
        return new UserBanViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull UserBanViewHolder holder, int position) {
        ...
        holder.buttonBan.setOnClickListener(view -> {
            ...
            userManagementService.banUser(userId).enqueue(new Callback<ResponseBody>() {
                @Override
